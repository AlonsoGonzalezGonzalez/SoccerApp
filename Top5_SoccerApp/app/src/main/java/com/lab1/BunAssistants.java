...
public class BunAssistants extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bunassistants);
        ...
        try {
            ...
            ResultSet rs = st.executeQuery("select * from bun_assists");
            ...
            rs.next();
            player = rs.getNString("name");
            team = rs.getNString("team");
            logo= rs.getNString("picture");
            assists = rs.getInt("no_assists");

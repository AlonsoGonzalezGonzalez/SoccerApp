...
public class BunScorers extends AppCompatActivity {

    ImageView image;
    Connection con;
    String team, scorer, logo;
    int goals;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.bunscorers);
        ...
        try {
            ...
            ResultSet rs = st.executeQuery("select * from bun_scorers");
            ...
            rs.next();
            scorer = rs.getNString("scorer");
            team = rs.getNString("team");
            logo= rs.getNString("picture");
            goals = rs.getInt("goals");
            text1.setText(scorer);
            text2.setText(team);
            text15.setText(Integer.toString(goals));
            ...
            logo= rs.getNString("picture");
            goals = rs.getInt("goals");
            text3.setText(scorer);
            text4.setText(team);
            text16.setText(Integer.toString(goals));
            ...
            logo= rs.getNString("picture");
            goals = rs.getInt("goals");
            text5.setText(scorer);
            text6.setText(team);
            text17.setText(Integer.toString(goals));
            ...
            logo= rs.getNString("picture");
            goals = rs.getInt("goals");
            text7.setText(scorer);
            text8.setText(team);
            text18.setText(Integer.toString(goals));
            ...
            logo= rs.getNString("picture");
            goals = rs.getInt("goals");
            text9.setText(scorer);
            text10.setText(team);
            text19.setText(Integer.toString(goals));
            ...
            logo= rs.getNString("picture");
            goals = rs.getInt("goals");
            text11.setText(scorer);
            text12.setText(team);
            text20.setText(Integer.toString(goals));
            ...
            logo= rs.getNString("picture");
            goals = rs.getInt("goals");
            text13.setText(scorer);
            text14.setText(team);
            text21.setText(Integer.toString(goals));

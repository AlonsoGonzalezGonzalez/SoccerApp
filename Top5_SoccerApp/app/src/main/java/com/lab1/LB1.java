...
public class LB1 extends AppCompatActivity {
    ...
    int htg1,atg1,htg2,atg2,htg3,atg3,htg4,atg4,htg5,atg5,atg6,htg7,atg7,htg8,atg8,htg9,atg9,htg10,atg10;
    int k = 0;
    Connection con;

    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.lbgame1);
